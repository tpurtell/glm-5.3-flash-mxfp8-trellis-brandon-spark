...
p=root/'results/bringup/emu-kiwi-dflash2-k7-eager-fp8kv-concurrency'
launch=root/'.work/launches/20260910T162932/launch.json'
...
while not (p/'summary.json').exists() or not json.loads((p/'summary.json').read_text()).get('completed'):
 ...
 time.sleep(5)
out=root/'results/bringup/emu-kiwi-dflash2-k7-eager-fp8kv-serial-suffix';out.mkdir(parents=True,exist_ok=False)
